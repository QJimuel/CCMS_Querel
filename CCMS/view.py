...
def ccmsObjectives(request):
    message = "<h1> CCMS Quality Objectives<br/> \
                ...
                <p>1. Increase faculty performance by obtaining a minimum rating of 4.00 in the semestral faculty evaluation of each faculty for the next fiveyears. </br> \
                   ...
                   3. Conduct a minimum of two (2) researches, IT projects or production of instructional materials annually for the next five years.Achieve a minimum \
                    of 50 percent student passing percentage in the IT certification annually for the next five years. </br>\
...
def ccmsMainPage(request):
    message = "<h1> CCMS <br/> \
                  </h1> \
                <p>Hello!, This is CCMS MainPage or HomePage </br>\
                </p>"
    return HttpResponse(message)
